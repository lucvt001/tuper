#ifndef THRUST_VECTOR_HORIZONTAL_RELAY_HPP
#define THRUST_VECTOR_HORIZONTAL_RELAY_HPP
...
class HorizontalThrustVectorRelay : public rclcpp::Node
{
public:
  /*
...
#endif // THRUST_VECTOR_HORIZONTAL_RELAY_HPP