...
tmux send-keys "ros2 launch arduagent rover_bringup.launch.py ns:=follower is_leader:=False mqtt_params_file:=src/tuper/arduagent/config/mqtt_params_follower.yaml" C-m
